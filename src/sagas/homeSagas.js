...
function *getHome(axios, actions){
    if(!actions.categoryName){
        const dados = yield axios.get('http://your domain.com/api/noticias/pages/' + actions.numPage)
        ...
        const dados = yield axios.get('http://your domain.com/api/noticias/category/' + actions.categoryName 
